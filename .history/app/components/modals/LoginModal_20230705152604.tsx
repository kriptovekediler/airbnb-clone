...
const LoginModal = () => {
  ...
  return (
    <Modal body={bodyContent} disabled={isLoading} onClose={loginModal.onClose} isOpen={loginModal.isOpen} onSubmit={handleSubmit(onSubmit)} title='Register' actionLabel='Continue' footer={footerContent}/>
  )
}
