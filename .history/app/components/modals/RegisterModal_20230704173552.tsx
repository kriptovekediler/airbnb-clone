...
const RegisterModal = () => {
  ...
  return (
    <Modal body={bodyContent} disabled={isLoading} onClose={registerModal.onClose} isOpen={registerModal.isOpen} onSubmit={handleSubmit(onSubmit)} title='Register' actionLabel='Continue' footer={footerContent}/>
  )
}
